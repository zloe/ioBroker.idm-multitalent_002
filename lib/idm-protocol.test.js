...
function dataParseTest() {
    ...
    const definition03 = idm.getDefinition('idm701100', idm.get_hex_from_byte(3));
    let text = idm.parseProtocol(data03,definition03);
    console.log(text);
    const definition04 = idm.getDefinition('idm701100', idm.get_hex_from_byte(4));
    text = idm.parseProtocol(data04,definition04);
    console.log(text);
    const definition05 = idm.getDefinition('idm701100', idm.get_hex_from_byte(5));
    text = idm.parseProtocol(data05,definition05);
    console.log(text);
    const definition06 = idm.getDefinition('idm701100', idm.get_hex_from_byte(6));
    text = idm.parseProtocol(data06,definition06);
    console.log(text);
    const definition07 = idm.getDefinition('idm701100', idm.get_hex_from_byte(7));
    text = idm.parseProtocol(data07,definition07);
    console.log(text);
    const definition08 = idm.getDefinition('idm701100', idm.get_hex_from_byte(8));
    text = idm.parseProtocol(data08,definition08);
    console.log(text);
    const definition09 = idm.getDefinition('idm701100', idm.get_hex_from_byte(9));
    text = idm.parseProtocol(data09,definition09);
    console.log(text);
    const definition0A = idm.getDefinition('idm701100', idm.get_hex_from_byte(10));
    text = idm.parseProtocol(data0A,definition0A);
    console.log(text);
    const definition0B = idm.getDefinition('idm701100', idm.get_hex_from_byte(11));
