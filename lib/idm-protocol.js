...
const idm_protocol = {
    ...
    initialize: function () {
        ...
        const idm712100 = ['03', '04', '05', '06', '07', '08', '09', '0A', '0B', '0C'];
        const idm712100_data = {
            version: 'idm712100',
            data_blocks: [
                {
                    block_number: '03',
        ...
        idm_protocol.dataDefinitions.set('idm712100', idm712100_data);
        idm_protocol.dataBlocks.set('idm712100', idm712100);
    ...
    interpret_data: function (version, data) {
        let text = '';
