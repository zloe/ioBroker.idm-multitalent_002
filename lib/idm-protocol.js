...
const idm_protocol = {
    ...
    initialize: function () {
        ...
        idm_protocol.dataDefinitions.set('EVR752101', idm_datablocks.idm750100_data);
        idm_protocol.dataBlocks.set('EVR752101', idm_datablocks.idm750100);
        idm_protocol.sensorDataBlocks.set('EVR752101', idm_datablocks.idm750100_sensors);
        idm_protocol.settingsDataBlocks.set('EVR752101', idm_datablocks.idm750100_settings);
