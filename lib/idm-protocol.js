...
const idm_protocol = {
    ...
    initialize: function () {
        ...
        idm_protocol.speed.set('idm701100', idm_datablocks.idm701100_speed);
        ...
        idm_protocol.speed.set('idm712100', idm_datablocks.idm712100_speed);

        idm_protocol.dataDefinitions.set('idm722100', idm_datablocks.idm722100_data);
        idm_protocol.dataBlocks.set('idm722100', idm_datablocks.idm722100);
        idm_protocol.sensorDataBlocks.set('idm722100', idm_datablocks.idm722100_sensors);
        idm_protocol.settingsDataBlocks.set('idm722100', idm_datablocks.idm722100_settings);
        idm_protocol.speed.set('idm722100', idm_datablocks.idm722100_speed);

        idm_protocol.dataDefinitions.set('S_H726100', idm_datablocks.S_H726100_data);
        idm_protocol.dataBlocks.set('S_H726100', idm_datablocks.S_H726100);
        idm_protocol.sensorDataBlocks.set('S_H726100', idm_datablocks.S_H726100_sensors);
        idm_protocol.settingsDataBlocks.set('S_H726100', idm_datablocks.S_H726100_settings);
        idm_protocol.speed.set('S_H726100', idm_datablocks.S_H726100_speed);
        ...
        idm_protocol.speed.set('idm750100', idm_datablocks.idm750100_speed);

        idm_protocol.dataDefinitions.set('EVR752101', idm_datablocks.evr752101_data);
        idm_protocol.dataBlocks.set('EVR752101', idm_datablocks.evr752101);
        idm_protocol.sensorDataBlocks.set('EVR752101', idm_datablocks.evr752101_sensors);
        idm_protocol.settingsDataBlocks.set('EVR752101', idm_datablocks.evr752101_settings);
        idm_protocol.speed.set('EVR752101', idm_datablocks.EVR752101_speed);
