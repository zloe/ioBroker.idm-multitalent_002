        ...
        if (startingNewCycle || startingNewFullCoverageCycle) {
            ...
            if (startingNewFullCoverageCycle) {
                if (this.fullCoverageCycleStartedAt != null) {
                    ...
                    this.log.info('completed one full cycle of all data blocks (every sensor and settings block read at least once) in ' +
                        (now - this.fullCoverageCycleStartedAt) + 'ms, total full cycles completed: ' + this.fullCoverageCycleCount);
                }
