        ...
        data_blocks: [
            {
                ...
                definition: [
                    { statename: '', field: 'padding', description: 'padding', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'Warmwasser.Sollwert', field: 'WW_soll', description: 'Warmwasser-Sollwert', length: 2, factor: 1, writable: false, function: 1 },
                    { statename: 'Heizung.SommerWinterUmschaltTemp', field: 'so_wi_temp', description: 'Sommer-Winter-Umsch.', length: 2, factor: 1, writable: false, function: 4 },
            ...
            },
            {
                ...
                definition: [
                    ...
                    { statename: 'Heizkreis-A.Nenntemperatur', field: 'tagtempA', description: 'Nenntemperatur', length: 2, factor: 1, writable: false, function: 6 },
                    { statename: 'Heizkreis-A.Spartemperatur', field: 'nachttem_A', description: 'Spartemperatur', length: 2, factor: 1, writable: false, function: 7 },
                    ...
                    { statename: 'Heizkreis-A.Betriebsart', field: 'betrieb_A', description: 'Betriebsart', length: 2, factor: 1, writable: false, function: 11 },
                    { statename: 'Heizkreis-A.Maximaltemperatur', field: 'max_A', description: 'Maximaltemperatur', length: 2, factor: 1, writable: false, function: 14 },
                    ...
                    { statename: 'Warmwasser.Betriebsart', field: 'betrieb_WW', description: 'Betriebsart Warmwasser', length: 1, factor: 1, writable: false, function: 23 },
                    { statename: 'Heizkreis-A.Minimaltemperatur', field: 'min_A', description: 'Minimaltemperatur', length: 2, factor: 1, writable: false, function: 26 },
                    ...
                    { statename: 'Heizkreis-A.Konstanttemperatur', field: 'konst_A', description: 'Konstanttemperatur', length: 2, factor: 1, writable: false, function: 58 },
                    ...
                    { statename: 'Heizkreis-C.Betriebsart', field: 'Betrieb_C', description: 'Betriebsart', length: 2, factor: 1, writable: false, function: 72 },
                    { statename: 'Heizkreis-D.Betriebsart', field: 'Betrieb_D', description: 'Betriebsart', length: 2, factor: 1, writable: false, function: 73 },
                    ...
                    { statename: 'Heizkreis-C.Konstanttemperatur', field: 'konst_C', description: 'Konstanttemperatur', length: 2, factor: 1, writable: false, function: 86 },
                    { statename: 'Heizkreis-D.Konstanttemperatur', field: 'konst_D', description: 'Konstanttemperatur', length: 2, factor: 1, writable: false, function: 87 },
                    { statename: 'Heizkreis-C.Maximaltemperatur', field: 'max_C', description: 'Maximaltemperatur', length: 2, factor: 1, writable: false, function: 88 },
                    { statename: 'Heizkreis-D.Maximaltemperatur', field: 'max_D', description: 'Maximaltemperatur', length: 2, factor: 1, writable: false, function: 89 },
                    { statename: 'Heizkreis-C.Minimaltemperatur', field: 'min_C', description: 'Minimaltemperatur', length: 2, factor: 1, writable: false, function: 90 },
                    { statename: 'Heizkreis-D.Minimaltemperatur', field: 'min_D', description: 'Minimaltemperatur', length: 2, factor: 1, writable: false, function: 91 },
                    { statename: 'Heizkreis-C.Spartemperatur', field: 'nachttem_C', description: 'Spartemperatur', length: 2, factor: 1, writable: false, function: 92 },
                    { statename: 'Heizkreis-D.Spartemperatur', field: 'nachttem_D', description: 'Spartemperatur', length: 2, factor: 1, writable: false, function: 93 },
                    ...
                    { statename: 'Heizkreis-D.Nenntemperatur', field: 'tagtemp_D', description: 'Nenntemperatur', length: 2, factor: 1, writable: false, function: 101 }
                ]
            },
            {
                block_number: '05',
                definition: [
                    ...
                    { statename: 'Heizkreis-B.Maximaltemperatur', field: 'max_B', description: 'Maximaltemp HK B', length: 2, factor: 1, writable: false, function: 15 },
                    { statename: 'Heizkreis-B.Kennlinie', field: 'steilheitB', description: 'Kennlinie HK B', length: 2, factor: 1, writable: false, function: 16 },
                    { statename: 'Heizkreis-B.Nenntemperatur', field: 'tagtemp_B', description: 'Nenntemp HK B', length: 2, factor: 1, writable: false, function: 17 },
                    { statename: 'Heizkreis-B.Spartemperatur', field: 'nachttem_B', description: 'Spartemp HK B', length: 2, factor: 1, writable: false, function: 18 },
