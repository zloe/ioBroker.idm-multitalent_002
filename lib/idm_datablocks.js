...
function validate(data) {
    ...
    for (const key of Object.keys(data)) {
        ...
        entry.data_blocks.forEach((block, blockIndex) => {
            ...
            // marker (see idm_datablocks.default.json's "_readme") and is intentionally
            // excluded from the collision check below.
            ...
            block.definition.forEach((field, fieldIndex) => {
                ...
                // this project before (see the 1.2.7 changelog entry), so it is checked here
                // for every data blocks file, not just the bundled one.
