        ...
        data_blocks: [
            ...
            },
            {
                ...
                definition: [
                    ...
                    { statename: '', field: 'padding6', description: 'padding6', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: '', field: 'padding7', description: 'padding7', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: '', field: 'padding8', description: 'padding8', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: '', field: 'padding9', description: 'padding9', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: '', field: 'padding10', description: 'padding10', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: '', field: 'padding11', description: 'padding11', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: '', field: 'padding12', description: 'padding12', length: 2, factor: 1, writable: false, function: -1 }
                    //{ statename: 'Kuehlung-B.Freigabe', field: 'cool_onB', description: 'Kühlung freigegeben B', length: 1, factor: 1, writable: true, function: 70 }
                ]
            },
            {
