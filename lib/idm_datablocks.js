...
const idm_datablocks = {
        ...
        data_blocks: [
            {
                ...
                definition: [
                    ...
                    { statename: 'Heizung.unbekannt', field: 'unbekannt', description: 'unbekannt', length: 2, factor: 1, writable: false, function: 56 },
            ...
            },
            {
                ...
                definition: [
                    ...
                    { statename: '', field: 'padding3', description: 'padding', length: 2, factor: 1, writable: false, function: -1 },
    ...
    idm712100_data: {
        ...
        data_blocks: [
            ...
            },
            {
                ...
                definition: [
                    { statename: '', field: 'padding', description: 'padding', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'Kuehlung-A.Freigabe', field: 'cool_onA', description: 'Kühlung freigegeben A', length: 1, factor: 1, writable: false, function: 45 },
                    ...
                    { statename: 'Kuehlung-B.Schaltdifferenz', field: 'diffco_B', description: 'Schaltdiff. Kühlung B', length: 2, factor: 0.1, writable: false, function: 69 },
                    { statename: 'Kuehlung-B.Freigabe', field: 'cool_onB', description: 'Kühlung freigegeben B', length: 1, factor: 1, writable: false, function: 70 }
                ]
            },
            {
                block_number: '09',
    ...
    /* idm750100
  ** block 3
{ statename: '', field: 'WW_soll', description: 'Warmwasser-Sollwert', length: 2, factor: 1, writable: false, function: 1 },
{ statename: '', field: 'so_wi_temp', description: 'Sommer-Winter-Umsch.', length: 2, factor: 1, writable: false, function: 4 },
{ statename: '', field: 'autowp', description: 'autom. Zuschaltung', length: 1, factor: 1, writable: false, function: 12 },
{ statename: '', field: 'zuzeit', description: 'Zuschaltzeit', length: 2, factor: 1, writable: false, function: 20 },
{ statename: '', field: 'notbetrieb', description: 'Notbetrieb', length: 1, factor: 1, writable: false, function: 24 },
{ statename: '', field: 'badsommer', description: 'Bad-Sommerbetrieb', length: 1, factor: 1, writable: false, function: 25 },
{ statename: '', field: 'wp_kund', description: 'WP-Freigabe Kunde', length: 1, factor: 1, writable: false, function: 36 },
{ statename: '', field: 'mindrehz', description: 'min. Drehzahl HZK-Pumpe', length: 2, factor: 1, writable: false, function: 48 },
{ statename: '', field: 'schichtpl', description: 'Schichttrennplatte', length: 1, factor: 1, writable: false, function: 55 },
{ statename: '', field: 'puffer', description: 'Puffer vorhanden', length: 1, factor: 1, writable: false, function: 56 },
{ statename: '', field: 'zirkzeit', description: 'Laufzeit Zirkulation', length: 2, factor: 1, writable: false, function: 57 },
{ statename: '', field: 'HGL_temp', description: 'gew. HGL-Temperatur', length: 2, factor: 0.1, writable: false, function: 66 },
{ statename: '', field: 'telkontakt', description: 'Funktion ext. Kontakt', length: 2, factor: 1, writable: false, function: 67 },

  ** block 4
{ statename: '', field: 'frost_A', description: 'Frostschutz', length: 1, factor: 1, writable: false, function: 2 },
{ statename: '', field: 'steilheitA', description: 'Kennlinie', length: 2, factor: 1, writable: false, function: 5 },
{ statename: '', field: 'tagtempA', description: 'Nenntemperatur', length: 2, factor: 1, writable: false, function: 6 },
{ statename: '', field: 'nachttem_A', description: 'Spartemperatur', length: 2, factor: 1, writable: false, function: 7 },
{ statename: '', field: 'fb_A', description: 'Art des Heizkreises', length: 1, factor: 1, writable: false, function: 8 },
{ statename: '', field: 'betrieb_A', description: 'Betriebsart', length: 2, factor: 1, writable: false, function: 11 },
{ statename: '', field: 'max_A', description: 'Maximaltemperatur', length: 2, factor: 1, writable: false, function: 14 },
{ statename: '', field: 'einfluss_A', description: 'Raumeinfluss', length: 1, factor: 1, writable: false, function: 21 },
{ statename: '', field: 'betrieb_WW', description: 'Betriebsart Warmwasser', length: 1, factor: 1, writable: false, function: 23 },
{ statename: '', field: 'min_A', description: 'Minimaltemperatur', length: 2, factor: 1, writable: false, function: 26 },
{ statename: '', field: 'prozent_A', description: 'Anteil Raumeinfluss', length: 2, factor: 1, writable: false, function: 29 },
{ statename: '', field: 'sensor_A', description: 'Raumeinfluss von', length: 1, factor: 1, writable: false, function: 31 },
{ statename: '', field: 'einflAauf', description: 'Raumeinfluss auf', length: 1, factor: 1, writable: false, function: 33 },
{ statename: '', field: 'einflBauf', description: 'Raumeinfluss auf', length: 1, factor: 1, writable: false, function: 34 },
{ statename: '', field: 'A_misch', description: 'mit Mischer', length: 1, factor: 1, writable: false, function: 42 },
{ statename: '', field: 'faktor_A', description: 'Absenkfaktor', length: 2, factor: 1, writable: false, function: 50 },
{ statename: '', field: 'absenkA', description: 'Schnellabsenkung', length: 1, factor: 1, writable: false, function: 52 },
{ statename: '', field: 'konst_A', description: 'Konstanttemperatur', length: 2, factor: 1, writable: false, function: 58 },
{ statename: '', field: 'C_misch', description: 'mit Mischer', length: 1, factor: 1, writable: false, function: 68 },
{ statename: '', field: 'D_misch', description: 'mit Mischer', length: 1, factor: 1, writable: false, function: 69 },
{ statename: '', field: 'absenkC', description: 'Schnellabsenkung', length: 1, factor: 1, writable: false, function: 70 },
{ statename: '', field: 'absenkD', description: 'Schnellabsenkung', length: 1, factor: 1, writable: false, function: 71 },
{ statename: '', field: 'Betrieb_C', description: 'Betriebsart', length: 2, factor: 1, writable: false, function: 72 },
{ statename: '', field: 'Betrieb_D', description: 'Betriebsart', length: 2, factor: 1, writable: false, function: 73 },
{ statename: '', field: 'einflCauf', description: 'Raumeinfluss auf', length: 1, factor: 1, writable: false, function: 76 },
{ statename: '', field: 'einflDauf', description: 'Raumeinfluss auf', length: 1, factor: 1, writable: false, function: 77 },
{ statename: '', field: 'Einfluss_C', description: 'Raumeinfluss', length: 1, factor: 1, writable: false, function: 78 },
{ statename: '', field: 'Einfluss_D', description: 'Raumeinfluss', length: 1, factor: 1, writable: false, function: 79 },
{ statename: '', field: 'faktor_C', description: 'Absenkfaktor', length: 2, factor: 1, writable: false, function: 80 },
{ statename: '', field: 'faktor_D', description: 'Absenkfaktor', length: 2, factor: 1, writable: false, function: 81 },
{ statename: '', field: 'FB_C', description: 'Art des Heizkreises', length: 1, factor: 1, writable: false, function: 82 },
{ statename: '', field: 'FB_D', description: 'Art des Heizkreises', length: 1, factor: 1, writable: false, function: 83 },
{ statename: '', field: 'frost_C', description: 'Frostschutz', length: 1, factor: 1, writable: false, function: 84 },
{ statename: '', field: 'frost_D', description: 'Frostschutz', length: 1, factor: 1, writable: false, function: 85 },
{ statename: '', field: 'konst_C', description: 'Konstanttemperatur', length: 2, factor: 1, writable: false, function: 86 },
{ statename: '', field: 'konst_D', description: 'Konstanttemperatur', length: 2, factor: 1, writable: false, function: 87 },
{ statename: '', field: 'max_C', description: 'Maximaltemperatur', length: 2, factor: 1, writable: false, function: 88 },
{ statename: '', field: 'max_D', description: 'Maximaltemperatur', length: 2, factor: 1, writable: false, function: 89 },
{ statename: '', field: 'min_C', description: 'Minimaltemperatur', length: 2, factor: 1, writable: false, function: 90 },
{ statename: '', field: 'min_D', description: 'Minimaltemperatur', length: 2, factor: 1, writable: false, function: 91 },
{ statename: '', field: 'nachttem_C', description: 'Spartemperatur', length: 2, factor: 1, writable: false, function: 92 },
{ statename: '', field: 'nachttem_D', description: 'Spartemperatur', length: 2, factor: 1, writable: false, function: 93 },
{ statename: '', field: 'prozentC', description: 'Anteil Raumeinfluss', length: 2, factor: 1, writable: false, function: 94 },
{ statename: '', field: 'prozentD', description: 'Anteil Raumeinfluss', length: 2, factor: 1, writable: false, function: 95 },
{ statename: '', field: 'sensorHK_C', description: 'Raumeinfluss von', length: 1, factor: 1, writable: false, function: 96 },
{ statename: '', field: 'sensorHK_D', description: 'Raumeinfluss von', length: 1, factor: 1, writable: false, function: 97 },
{ statename: '', field: 'steilheitC', description: 'Kennlinie', length: 2, factor: 1, writable: false, function: 98 },
{ statename: '', field: 'steilheitD', description: 'Kennlinie', length: 2, factor: 1, writable: false, function: 99 },
{ statename: '', field: 'tagtemp_D', description: 'Nenntemperatur', length: 2, factor: 1, writable: false, function: 101 },

  ** block 5
{ statename: '', field: 'frost_B', description: 'Frostschutz', length: 1, factor: 1, writable: false, function: 3 },
{ statename: '', field: 'fb_B', description: 'Art des Heizkreises', length: 1, factor: 1, writable: false, function: 13 },
{ statename: '', field: 'max_B', description: 'Maximaltemperatur', length: 2, factor: 1, writable: false, function: 15 },
{ statename: '', field: 'steilheitB', description: 'Kennlinie', length: 2, factor: 1, writable: false, function: 16 },
{ statename: '', field: 'tagtemp_B', description: 'Nenntemperatur', length: 2, factor: 1, writable: false, function: 17 },
{ statename: '', field: 'nachttem_B', description: 'Spartemperatur', length: 2, factor: 1, writable: false, function: 18 },
{ statename: '', field: 'betrieb_B', description: 'Betriebsart', length: 2, factor: 1, writable: false, function: 19 },
{ statename: '', field: 'einfluss_B', description: 'Raumeinfluss', length: 1, factor: 1, writable: false, function: 22 },
{ statename: '', field: 'min_B', description: 'Minimaltemperatur', length: 2, factor: 1, writable: false, function: 27 },
{ statename: '', field: 'prozent_B', description: 'Anteil Raumeinfluss', length: 2, factor: 1, writable: false, function: 30 },
{ statename: '', field: 'sensor_B', description: 'Raumeinfluss von', length: 1, factor: 1, writable: false, function: 32 },
{ statename: '', field: 'B_misch', description: 'mit Mischer', length: 1, factor: 1, writable: false, function: 43 },
{ statename: '', field: 'faktor_B', description: 'Absenkfaktor', length: 2, factor: 1, writable: false, function: 51 },
{ statename: '', field: 'absenkB', description: 'Schnellabsenkung', length: 1, factor: 1, writable: false, function: 53 },
{ statename: '', field: 'konst_B', description: 'Konstanttemperatur', length: 2, factor: 1, writable: false, function: 59 },

  ** block 6
{ statename: '', field: 'wp_fg', description: 'WP-Freigabe', length: 1, factor: 1, writable: false, function: 9 },
{ statename: '', field: 'diffwp', description: 'WP Schaltdifferenz', length: 2, factor: 1, writable: false, function: 35 },
{ statename: '', field: 'WP_max', description: 'WP Maximaltemp.', length: 2, factor: 1, writable: false, function: 37 },
{ statename: '', field: 'min_LfZt', description: 'min. Laufzeit', length: 2, factor: 1, writable: false, function: 38 },
{ statename: '', field: 'min_StStZt', description: 'min. Stehzeit', length: 2, factor: 1, writable: false, function: 39 },
{ statename: '', field: 'minsolwarn', description: 'min. Solewarnung', length: 2, factor: 1, writable: false, function: 40 },
{ statename: '', field: 'minsolalrm', description: 'min. Solealarm', length: 2, factor: 1, writable: false, function: 44 },

  ** block 7
{ statename: '', field: 'R_1', description: 'Solepumpe', length: 1, factor: 1, writable: false, function: 216 },
{ statename: '', field: 'relais2', description: 'WP Stufe 1', length: 1, factor: 1, writable: false, function: 217 },
{ statename: '', field: 'relais3', description: 'Mischer A - auf', length: 1, factor: 1, writable: false, function: 218 },
{ statename: '', field: 'relais4', description: 'Mischer A - zu', length: 1, factor: 1, writable: false, function: 219 },
{ statename: '', field: 'relais5', description: 'Prozessumkehr', length: 1, factor: 1, writable: false, function: 220 },
{ statename: '', field: 'relais6', description: 'Pumpe Heizkreis B', length: 1, factor: 1, writable: false, function: 221 },
{ statename: '', field: 'relais7', description: 'Mischer B - auf', length: 1, factor: 1, writable: false, function: 222 },
{ statename: '', field: 'relais8', description: 'Mischer B - zu', length: 1, factor: 1, writable: false, function: 223 },
{ statename: '', field: 'relais9', description: 'Kühlventil', length: 1, factor: 1, writable: false, function: 224 },
{ statename: '', field: 'relais10', description: 'HG-Mischer - auf', length: 1, factor: 1, writable: false, function: 225 },
{ statename: '', field: 'relais11', description: 'HG-Mischer - zu', length: 1, factor: 1, writable: false, function: 226 },
{ statename: '', field: 'relais12', description: 'Zirkulationspumpe', length: 1, factor: 1, writable: false, function: 227 },
{ statename: '', field: 'relais13', description: 'Störmeldeausgang', length: 1, factor: 1, writable: false, function: 228 },
{ statename: '', field: 'triac1', description: 'Plattentauscherpumpe', length: 2, factor: 1, writable: false, function: 229 },
{ statename: '', field: 'triac2', description: 'Ladepumpe', length: 2, factor: 1, writable: false, function: 230 },
{ statename: '', field: 'triac3', description: 'Pumpe Heizkreis A', length: 2, factor: 1, writable: false, function: 231 },
{ statename: '', field: 'uebertemp', description: 'Übertemperatur', length: 1, factor: 1, writable: false, function: 248 },
{ statename: '', field: 'telefon', description: 'Telefonkontakt', length: 1, factor: 1, writable: false, function: 253 },

  ** block 9
{ statename: '', field: 'mindrehz2', description: 'min. Drehzahl Ladepumpe', length: 2, factor: 1, writable: false, function: 62 },

  ** block 11
{ statename: '', field: 'ueberhitz1', description: 'Soll-Überhitzung', length: 2, factor: 0.1, writable: false, function: 121 },
{ statename: '', field: 'zyklzeit', description: 'Zykluszeit', length: 2, factor: 1, writable: false, function: 122 },
{ statename: '', field: 'startoeffn', description: 'Startöffnung', length: 2, factor: 1, writable: false, function: 123 },
{ statename: '', field: 'Err_EV', description: 'Fehler Schrittmotor', length: 1, factor: 1, writable: false, function: 271 },
{ statename: '', field: 'I05_DigiIn', description: 'Freigabe Kompressor', length: 1, factor: 1, writable: false, function: 272 },
{ statename: '', field: 'I05_Pos', description: 'Position E-Ventil', length: 2, factor: 1, writable: false, function: 273 },
{ statename: '', field: 'sauggas', description: 'Sauggastemperatur', length: 2, factor: 0.01, writable: false, function: 274 },
{ statename: '', field: 'saugp', description: 'Sauggasdruck', length: 2, factor: 0.1, writable: false, function: 275 },
{ statename: '', field: 'ueberhitz', description: 'Ist-Überhitzung', length: 2, factor: 0.01, writable: false, function: 276 },

  ** block 12
{ statename: '', field: 'Sekunde', description: 'Sekunde', length: 1, factor: 1, writable: false, function: 202 },
{ statename: '', field: 'Minute', description: 'Minute', length: 1, factor: 1, writable: false, function: 203 },
{ statename: '', field: 'Stunde', description: 'Stunde', length: 1, factor: 1, writable: false, function: 204 },
{ statename: '', field: 'Tag', description: 'Tag', length: 1, factor: 1, writable: false, function: 205 },
{ statename: '', field: 'Monat', description: 'Monat', length: 1, factor: 1, writable: false, function: 206 },
{ statename: '', field: 'Jahr', description: 'Jahr', length: 2, factor: 1, writable: false, function: 236 },

  ** block 13
{ statename: '', field: 'aussentemp', description: 'Außentemperatur', length: 2, factor: 1, writable: false, function: 207 },
{ statename: '', field: 'Zapftemp', description: 'Zapftemperatur', length: 2, factor: 1, writable: false, function: 208 },
{ statename: '', field: 'Speichtemp', description: 'Speichertemperatur', length: 2, factor: 1, writable: false, function: 209 },
{ statename: '', field: 'solltemp_A', description: 'Soll-Vorlauf A', length: 2, factor: 1, writable: false, function: 211 },
{ statename: '', field: 'solltemp_B', description: 'Soll-Vorlauf B', length: 2, factor: 1, writable: false, function: 212 },
{ statename: '', field: 'WP_Temp', description: 'WP-Vorlauf', length: 2, factor: 1, writable: false, function: 213 },
{ statename: '', field: 'WP_RL', description: 'WP-Rücklauf', length: 2, factor: 1, writable: false, function: 214 },
{ statename: '', field: 'raum_A', description: 'Raumtemperatur A', length: 2, factor: 0.1, writable: false, function: 233 },
{ statename: '', field: 'raum_B', description: 'Raumtemperatur B', length: 2, factor: 0.1, writable: false, function: 234 },
{ statename: '', field: 'Vorl_A', description: 'Vorlauf Heizkreis A', length: 2, factor: 1, writable: false, function: 249 },
{ statename: '', field: 'Vorl_B', description: 'Vorlauf Heizkreis B', length: 2, factor: 1, writable: false, function: 250 },
{ statename: '', field: 'hg_temp', description: 'HG-Temperatur', length: 2, factor: 0.1, writable: false, function: 254 },
{ statename: '', field: 'Sole_Temp', description: 'Sole-Austrittstemp.', length: 2, factor: 1, writable: false, function: 258 },

  ** block 14
{ statename: '', field: 'sommer', description: 'Sommerbetrieb', length: 1, factor: 1, writable: false, function: 210 },
{ statename: '', field: 'error3', description: 'Fühlerdefekt', length: 1, factor: 1, writable: false, function: 215 },
{ statename: '', field: 'HD_Warn', description: 'Hochdruckstörung', length: 1, factor: 1, writable: false, function: 237 },
{ statename: '', field: 'ND_Warn', description: 'Niederdruckstörung', length: 1, factor: 1, writable: false, function: 238 },
{ statename: '', field: 'Thermwarn', description: 'Thermorelaisstörung', length: 1, factor: 1, writable: false, function: 239 },
{ statename: '', field: 'Inputwarn', description: 'Sole zu kalt', length: 1, factor: 1, writable: false, function: 240 },
{ statename: '', field: 'error4', description: 'Verhältnis Std/Imp', length: 1, factor: 1, writable: false, function: 241 },
{ statename: '', field: 'WP_warn', description: 'Spreizung zu hoch', length: 1, factor: 1, writable: false, function: 242 },
{ statename: '', field: 'sperrzeit', description: 'Sperrzeit', length: 1, factor: 1, writable: false, function: 246 },
{ statename: '', field: 'cool', description: 'Kühlfuntion', length: 1, factor: 1, writable: false, function: 247 },
{ statename: '', field: 'vorrang', description: 'Vorrangschaltung', length: 1, factor: 1, writable: false, function: 251 },
