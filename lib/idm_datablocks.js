...
// Heizkreisart: 0 = Heizkoerper, 1 = Fussboden
// Mischervorhanden: 0 = kein Mischer, 1 = Mischer, 3 = Mischer ??
// Funktion externer Kontakt: 0 = Betriebsartumschaltung (auf Dauernennbetrieb und Freigabe Speicherladung), 1 = direkte WP Steuerung, 2 = Rundsteuerempfaenger
const idm_datablocks = {
        ...
        data_blocks: [
            {
                ...
                definition: [
                    ...
                    // function was 57 before, colliding with the "Laufzeit Zirkulation" field above - this position's
                    // real register is not identified yet, so it is intentionally marked as -1 (not writable) instead
                    // of guessing a number. Do not set writable=true here without confirming the correct function id.
                    { statename: 'Heizung.LaufzeitZirkulation', field: 'zirkzeit', description: 'unbekannt', length: 2, factor: 1, writable: false, function: -1 },
    ...
    idm722100: ['03', '04', '05', '06', '07', '08', '09', '0A', '0B', '0C', '0D'],
    idm722100_sensors: ['07', '0B', '0C', '0D'],
    idm722100_settings: [ '03', '04', '05', '06', '08', '09', '0A' ],
    idm722100_speed: 75,
    idm722100_data: {
        version: 'idm722100',
        data_blocks: [
    ...
    S_H726100_settings: [ '03', '04', '05', '06', '08', '09', '0A' ],
    S_H726100_speed: 100,
    S_H726100_data: {
        version: 'S_H726100',
        data_blocks: [
            {
                ...
                definition: [
                    ...
                    { statename: 'Heizung.BadSommerbetrieb', field: 'badsommer', description: 'Bad-Sommerbetrieb', length: 1, factor: 1, writable: false, function: 25 },
                    { statename: 'Heizung.SchichttrennplatteVorhanden', field: 'schichtpl', description: 'Schichttrennplatte', length: 2, factor: 1, writable: false, function: 55 },
                    //{ statename: 'Heizung.unbekannt', field: 'unbekannt', description: 'unbekannt', length: 2, factor: 1, writable: false, function: 57 },
                    { statename: 'Heizung.MinDrehzahlHZK-Pumpe', field: 'mindrehz', description: 'min. Drehzahl HZK-Pumpe', length: 2, factor: 1, writable: false, function: 48 },
                    { statename: 'Heizung.PufferVorhanden', field: 'puffer', description: 'Puffer vorhanden', length: 2, factor: 1, writable: false, function: 56 },
                    // was function: 56 (duplicate of "Puffer vorhanden" above) with description "unbekannt" - all other
                    // supported control versions (idm712100, idm750100, EVR752101) agree that this field is
                    // "Laufzeit Zirkulation" with function 57, so aligning this entry with that consistent pattern.
                    { statename: 'Heizung.LaufzeitZirkulation', field: 'zirkzeit', description: 'Laufzeit Zirkulation', length: 2, factor: 1, writable: false, function: 57 },
                    { statename: 'Heizung.HGL-Temperatur', field: 'HGL_temp', description: 'gew. HGL-Temperatur', length: 2, factor: 0.1, writable: true, function: 66 },
                    { statename: 'Heizung.ExternerKontakt', field: 'telkontakt', description: 'Funktion ext. Kontakt', length: 2, factor: 1, writable: false, function: 67 },
                    { statename: 'Heizung.Restzeit', field: 'restzeit', description: 'Restzeit?', length: 2, factor: 1, writable: false, function: 132 }
            ...
            },
            {
                ...
                definition: [
                    ...
                    { statename: 'Heizkreis-A.MischerVorhanden', field: 'A_misch', description: 'mit Mischer A', length: 1, factor: 1, writable: false, function: 42 },
                    { statename: '', field: 'padding2', description: 'padding2', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: '', field: 'padding3', description: 'passing3', length: 1, factor: 1, writable: false, function: -1 },
                    { statename: '', field: 'padding4', description: 'padding4', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'Heizkreis-A.Absenkfaktor', field: 'faktor_A', description: 'Absenkfaktor A', length: 1, factor: 1, writable: false, function: 50 },
                    { statename: '', field: 'padding5', description: 'padding5', length: 1, factor: 1, writable: false, function: -1 },
                    { statename: 'Heizkreis-A.Schnellabsenkung', field: 'absenkA', description: 'Schnellabsenkung A', length: 1, factor: 1, writable: false, function: 52 },
                    { statename: 'Heizkreis-A.Konstanttemperatur', field: 'konst_A', description: 'Konstanttemperatur A', length: 2, factor: 1, writable: true, function: 58 },
                    { statename: 'Heizkreis-C.MischerVorhanden', field: 'C_misch', description: 'mit Mischer C', length: 1, factor: 1, writable: false, function: 68 },
                    { statename: 'Heizkreis-D.MischerVorhanden', field: 'D_misch', description: 'mit Mischer D', length: 1, factor: 1, writable: false, function: 69 },
                    { statename: 'Heizkreis-C.Schnellabsenkung', field: 'absenkC', description: 'Schnellabsenkung C', length: 1, factor: 1, writable: false, function: 70 },
                    { statename: 'Heizkreis-D.Schnellabsenkung', field: 'absenkD', description: 'Schnellabsenkung D', length: 1, factor: 1, writable: false, function: 71 },
                    { statename: 'Heizkreis-C.Betriebsart', field: 'Betrieb_C', description: 'Betriebsart C', length: 2, factor: 1, writable: true, function: 72 },
                    { statename: 'Heizkreis-D.Betriebsart', field: 'Betrieb_D', description: 'Betriebsart D', length: 2, factor: 1, writable: true, function: 73 },
                    { statename: '', field: 'padding6', description: 'padding6', length: 1, factor: 1, writable: false, function: -1 },
                    { statename: 'Heizkreis-C.RaumeinflussAuf', field: 'einflCauf', description: 'Raumeinfluss auf C', length: 1, factor: 1, writable: false, function: 76 },
                    { statename: '', field: 'padding7', description: 'padding7', length: 1, factor: 1, writable: false, function: -1 },
                    { statename: 'Heizkreis-D.RaumeinflussAuf', field: 'einflDauf', description: 'Raumeinfluss auf D', length: 1, factor: 1, writable: false, function: 77 },
                    { statename: '', field: 'padding8', description: 'padding8', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'Heizkreis-C.Raumeinfluss', field: 'Einfluss_C', description: 'Raumeinfluss C', length: 1, factor: 1, writable: false, function: 78 },
                    { statename: 'Heizkreis-D.Raumeinfluss', field: 'Einfluss_D', description: 'Raumeinfluss D', length: 1, factor: 1, writable: false, function: 79 },
                    { statename: 'Heizkreis-C.Absenkfaktor', field: 'faktor_C', description: 'Absenkfaktor C', length: 2, factor: 1, writable: false, function: 80 },
                    { statename: 'Heizkreis-D.Absenkfaktor', field: 'faktor_D', description: 'Absenkfaktor D', length: 2, factor: 1, writable: false, function: 81 },
                    { statename: 'Heizkreis-C.HeizkreisArt', field: 'FB_C', description: 'Art des Heizkreises C', length: 1, factor: 1, writable: false, function: 82 },
                    { statename: 'Heizkreis-D.HeizkreisArt', field: 'FB_D', description: 'Art des Heizkreises D', length: 1, factor: 1, writable: false, function: 83 },
                    { statename: 'Heizkreis-C.Frostschutz', field: 'frost_C', description: 'Frostschutz C', length: 1, factor: 1, writable: false, function: 84 },
                    { statename: 'Heizkreis-D.Frostschutz', field: 'frost_D', description: 'Frostschutz D', length: 1, factor: 1, writable: false, function: 85 },
                    { statename: 'Heizkreis-C.Konstanttemperatur', field: 'konst_C', description: 'Konstanttemperatur C', length: 2, factor: 1, writable: true, function: 86 },
                    { statename: 'Heizkreis-D.Konstanttemperatur', field: 'konst_D', description: 'Konstanttemperatur D', length: 2, factor: 1, writable: true, function: 87 },
                    { statename: 'Heizkreis-C.Maximaltemperatur', field: 'max_C', description: 'Maximaltemperatur C', length: 2, factor: 1, writable: true, function: 88 },
                    { statename: 'Heizkreis-D.Maximaltemperatur', field: 'max_D', description: 'Maximaltemperatur D', length: 2, factor: 1, writable: true, function: 89 },
                    { statename: 'Heizkreis-C.Minimaltemperatur', field: 'min_C', description: 'Minimaltemperatur C', length: 2, factor: 1, writable: true, function: 90 },
                    { statename: 'Heizkreis-D.Minimaltemperatur', field: 'min_D', description: 'Minimaltemperatur D', length: 2, factor: 1, writable: true, function: 91 },
                    { statename: 'Heizkreis-C.Spartemperatur', field: 'nachttem_C', description: 'Spartemperatur C', length: 2, factor: 1, writable: true, function: 92 },
                    { statename: 'Heizkreis-D.Spartemperatur', field: 'nachttem_D', description: 'Spartemperatur D', length: 2, factor: 1, writable: true, function: 93 },
                    { statename: 'Heizkreis-C.AnteilRaumeinfluss', field: 'prozentC', description: 'Anteil Raumeinfluss C', length: 2, factor: 1, writable: false, function: 94 },
                    { statename: 'Heizkreis-D.AnteilRaumeinfluss', field: 'prozentD', description: 'Anteil Raumeinfluss D', length: 2, factor: 1, writable: false, function: 95 },
                    { statename: 'Heizkreis-C.RaumeinflussVon', field: 'sensorHK_C', description: 'Raumeinfluss von C', length: 1, factor: 1, writable: false, function: 96 },
                    { statename: 'Heizkreis-D.RaumeinflussVon', field: 'sensorHK_D', description: 'Raumeinfluss von D', length: 1, factor: 1, writable: false, function: 97 },
                    { statename: 'Heizkreis-C.Kennlinie', field: 'steilheitC', description: 'Kennlinie C', length: 2, factor: 1, writable: false, function: 98 },
                    { statename: 'Heizkreis-D.Kennlinie', field: 'steilheitD', description: 'Kennlinie D', length: 2, factor: 1, writable: false, function: 99 },
                    { statename: 'Heizkreis-C.Nenntemperatur', field: 'tagtemp_C', description: 'Nenntemperatur C', length: 2, factor: 1, writable: true, function: 100 },
                    { statename: 'Heizkreis-D.Nenntemperatur', field: 'tagtemp_D', description: 'Nenntemperatur D', length: 2, factor: 1, writable: true, function: 101 }
                ]
            },
            {
                block_number: '05',
                definition: [
                    ...
                    { statename: 'Heizkreis-B.AnteilRaumeinfluss', field: 'prozent_B', description: 'Anteil Raumeinfluss B', length: 2, factor: 1, writable: false, function: 30 },
                    { statename: 'Heizkreis-B.RaumeinflussVon', field: 'sensor_B', description: 'Raumeinfluss B von', length: 1, factor: 1, writable: false, function: 32 },
                    // was function: 32 (duplicate of "Raumeinfluss B von" above) - every other supported control
                    // version (idm701100, idm712100, idm722100, EVR752101) uses function 34 for "Raumeinfluss B auf",
                    // so aligning this entry with that consistent pattern.
                    { statename: 'Heizkreis-B.RaumeinflussAuf', field: 'einflBauf', description: 'Raumeinfluss B auf', length: 1, factor: 1, writable: false, function: 34 },
                    { statename: 'Heizkreis-B.Absenkfaktor', field: 'faktor_B', description: 'Absenkfaktor B', length: 2, factor: 1, writable: false, function: 51 },
                    { statename: 'Heizkreis-B.MischerVorhanden', field: 'B_misch', description: 'HK B mit Mischer', length: 1, factor: 1, writable: false, function: 43 },
                    { statename: 'Heizkreis-B.Konstanttemperatur', field: 'konst_B', description: 'Konstanttemp B', length: 2, factor: 1, writable: true, function: 59 },
            ...
            },
            {
                ...
                definition: [
                    ...
                    { statename: 'Kuehlung-B.Minimaltemperatur', field: 'mincoolB', description: 'min. Kühlkreistemp B', length: 2, factor: 1, writable: false, function: 68 },
                    { statename: 'Kuehlung-B.Schaltdifferenz', field: 'diffco_B', description: 'Schaltdiff. Kühlung B', length: 2, factor: 0.1, writable: true, function: 69 },
                    { statename: '', field: 'padding3', description: 'padding3', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: '', field: 'padding4', description: 'padding4', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: '', field: 'padding5', description: 'padding5', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'PID.Integral', field: 'Integral', description: 'Integralanteil', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'PID.Differential', field: 'Differential', description: 'Differentialanteil', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'PID.Proportional', field: 'Proportional', description: 'Proportionalanteil', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'PID.Vorhaltezeit', field: 'Vorhaltezeit', description: 'Vorhaltezeit', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'PID.Nachstellzeit', field: 'Nachstellzeit', description: 'Nachstellzeit', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'PID.minDrehzahl', field: 'minDrehzahl', description: 'minimale Drehzahl', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'PID.Deviation', field: 'Deviation', description: 'Deviation', length: 2, factor: 1, writable: false, function: -1 }
                    //{ statename: 'Kuehlung-B.Freigabe', field: 'cool_onB', description: 'Kühlung freigegeben B', length: 1, factor: 1, writable: true, function: 70 }
                ]
            },
            {
            ...
            },
            {
                ...
                definition: [
                    { statename: '', field: 'padding', description: 'padding', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: '', field: 'padding2', description: 'padding2', length: 2, factor: 1, writable: false, function: -1 },
                    { statename: 'Heizung.MaxTempDirectControl', field: 'MaxTempDirectControl', description: 'max. Temp when direct control with external contact', length: 2, factor: 1, writable: false, function: -1 },
                ]
            },
            {
                block_number: '0B',
        ...
        data_blocks: [
            ...
            },
            {
                ...
                definition: [
                    ...
                    { statename: 'Heizung.Sperrzeit', field: 'sperrzeit', description: 'Sperrzeit', length: 1, factor: 1, writable: false, function: 246 },
                    { statename: 'Heizung.Kuehlfunktion', field: 'cool', description: 'Kühlfuntion', length: 1, factor: 1, writable: false, function: 247 },
                    { statename: 'Warmwasser.Vorrangschaltung', field: 'vorrang', description: 'Vorrangschaltung', length: 1, factor: 1, writable: true, function: 251 },
                ]
            }
        ]
    },
