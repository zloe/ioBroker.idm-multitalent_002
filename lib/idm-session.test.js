...
describe('idm-session (connection + request/response state machine)', () => {
    ...
    describe('multi-block collection, sensor and settings (S_H726100 - see pollPattern / beginGroupCollection())', () => {
        ...
        it('happy path: one full pattern cycle (sensor, sensor, settings), each group completing on its first content reply', () => {
            const socket = connectAsH726100();
            ...
            // completed) and settings once: 4 + 4 + 7 = 15, not just 11.
